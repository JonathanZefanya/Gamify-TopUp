...
@section('content')
    <div class="content container-fluid">
        ...
        <div class="alert alert-soft-dark mb-5" role="alert">
            <div class="d-flex align-items-center">
                ...
                <div class="flex-grow-1 ms-3">
                    <div class="d-flex align-items-center">
                        @php($currentTheme = isset($theme) ? $theme : basicControl()->theme)
                        <p class="mb-0">{{ __('You are editing static :name page for :language version in :theme', [
                            'name' => optional($page->details)->name ?? ($page->name ?? ''),
                            'language' => $pageEditableLanguage->name ?? '',
                            'theme' => stringToTitle($currentTheme)
                        ]) }}</p>
                    </div>
                </div>
            </div>
      ...
      <form action="{{ route("admin.update.static.page", [$page->id, $currentTheme]) }}" method="post"
